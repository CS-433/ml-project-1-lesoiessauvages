    ...
    for degree in degrees:
        ...
        for lambda_ in lambdas:
            ...
            for k in range(k_fold):
                sum_rmse_te += cross_validation_lambda_degree(
    ...
    for degree in degrees:
        ...
        for lambda_ in lambdas:
            ...
            for gamma in gammas:
                sum_rmse_te = 0
                for k in range(k_fold):
                    sum_rmse_te += cross_validation_lambda_degree_gamma(
                        y, x, k_indices, k, lambda_, degree, gamma
                    )
                print(
                    "lambda : "
                    + str(lambda_)
            ...
            best_gamma_for_lambda.append(
                gammas[np.argmin(rmse_for_degree_lambda_gamma)]
            )
