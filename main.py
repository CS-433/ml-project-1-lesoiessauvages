...
if __name__ == '__main__':
    ...
    phi_train = build_poly(x_train, 10)
...
# TODO: remove 999
    ...
    w, loss = logistic_regression(y_train_tr, x_train_tr, initial_w, 300, 100)
    # w, loss = logistic_regression(y_train, phi_train, initial_w, 600, 0.05)
